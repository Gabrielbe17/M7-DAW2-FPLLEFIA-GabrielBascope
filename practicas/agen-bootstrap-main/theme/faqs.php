        ...
        <div class="col-12">
          <div id="accordion">
            <?php foreach ($faqs as $index => $faq) {
              echo "<div class='card mb-4 rounded-0 border-0'>
        <div class='card-header rounded-0 bg-white border p-0 border-0'>
            <a class='card-link h4 d-flex tex-dark mb-0 py-3 px-4 justify-content-between' data-toggle='collapse' href='#accordion{$index}'>
